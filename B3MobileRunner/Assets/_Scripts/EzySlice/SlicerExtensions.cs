...
namespace EzySlice
{
    ...
    public static class SlicerExtensions
    {
        ...
        public static GameObject[] SliceInstantiate(this GameObject obj, Vector3 position, Vector3 direction, Material crossSectionMat, bool isSkinnedMeshRenderer, params SkinnedMeshRenderer[] optionalSkinnedMeshRenderer)
        {
            if (isSkinnedMeshRenderer)
            {
                return SliceInstantiateSkinnedMeshRenderer(obj, position, direction, new TextureRegion(0.0f, 0.0f, 1.0f, 1.0f), optionalSkinnedMeshRenderer[0], crossSectionMat);
            }
            else
            {
                return SliceInstantiate(obj, position, direction, new TextureRegion(0.0f, 0.0f, 1.0f, 1.0f), crossSectionMat);
        ...
        public static GameObject[] SliceInstantiateSkinnedMeshRenderer(this GameObject obj, Vector3 position, Vector3 direction, TextureRegion cuttingRegion, SkinnedMeshRenderer smr, Material crossSectionMaterial = null)
        {
            ...
            return SliceInstantiateSkinnedMeshRenderer(obj, cuttingPlane, cuttingRegion, smr, crossSectionMaterial);
        }

        public static GameObject[] SliceInstantiateSkinnedMeshRenderer(this GameObject obj, Plane pl, TextureRegion cuttingRegion, SkinnedMeshRenderer smr, Material crossSectionMaterial = null)
        {
            SlicedHull slice = Slicer.SliceSkinnedMeshRenderer(obj, pl, cuttingRegion, crossSectionMaterial, smr);
            ...
            GameObject upperHull = slice.CreateUpperHullWithSkinnedMeshRenderer(obj, crossSectionMaterial, smr);
            GameObject lowerHull = slice.CreateLowerHullWithSkinnedMeshRenderer(obj, crossSectionMaterial, smr);
